...
import * as styles from "../../page/mypage/index/Mypage.css";
import Divider from "@common/component/Divider/Divider";
import Tab from "@common/component/Tab/Tab";
import { useEffect, useState } from "react";
import MyPageContent from "../../page/mypage/index/component/MyPageContent/MyPageContent";
...
export default function MyPage() {
  ...
  const preSavedActiveTab = typeof window !== 'undefined' ? sessionStorage.getItem("activeTab") : null;
        ...
        <HeaderNav
          ...
          rightBtn={
            <span
              ...
              onClick={() => isLogin && router.push("/setting")}
            >
            ...
            {isRegister ? (
              <div className={styles.animalProfileWrapper}>
                ...
                <IcChevronRight
                  ...
                  onClick={() => router.push("/mypage/edit-pet")}
                />
              </div>
            ) : (
